    ...
    <div className="privacy-policy-container">
        ...
        <div className="sub-section">
          ...
          <ul>
            ...
            <li>
              ...
              in this Agreement) refers to Just Shopper, No.9 old 2a 3rd cross
              st, Vijayanagar velachery.
            </li>
            <li>
            ...
            <li>Country refers to: Tamil Nadu, India</li>
            <li>
              {" "}
      ...
      <div className="section">
        ...
        <ul>
          <li>
            By email:{" "}
            <a href="mailto:justshofferofficial@gmail.com">
              justshofferofficial@gmail.com
            </a>
          </li>
          <li>
